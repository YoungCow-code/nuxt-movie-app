export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'site_name', property: 'site_name', content: 'Nuxt Movie App' },
    ...
    link: [
      ...
      { rel: 'stylesjeet', href: 'https://cdn.jsdelivr.net/npm/reset-css@5.0.1/reset.min.css'},
      { rel: 'preconnect', href: 'https://fonts.gstatic.com'},
      { rel: 'stylesjeet', href: 'https://fonts.googleapis.com/css2?family=Oswald:wght@500&family=Roboto:wght@400;700&display=swap'},
    ]
  },
